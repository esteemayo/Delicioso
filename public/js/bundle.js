...
},{}],"authService.js":[function(require,module,exports) {
"use strict";
...
var AUTH_ENDPOINTS = 'http://localhost:9999/api/v1/users';
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(AUTH_ENDPOINTS, "/login"),
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat(AUTH_ENDPOINTS, "/logout")
            });
          ...
          case 3:
            ...
            if (data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged you out!');
              window.setTimeout(function () {
                location.assign('/');
              });
            }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(AUTH_ENDPOINTS, "/forgotPassword"),
              data: {
                email: email
              }
            });
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"userService.js":[function(require,module,exports) {
"use strict";
...
var USER_ENDPOINTS = 'http://localhost:9999/api/v1/users';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(USER_ENDPOINTS, "/register"),
              data: data
            });
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateService.js":[function(require,module,exports) {
"use strict";
...
var UPDATE_ENDPOINTS = 'http://localhost:9999/api/v1/users';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? "".concat(UPDATE_ENDPOINTS, "/updateMyPassword") : "".concat(UPDATE_ENDPOINTS, "/updateMe");
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"heart.js":[function(require,module,exports) {
"use strict";
...
function _ajaxHeart() {
  _ajaxHeart = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var _this = this;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            (0, _bling.$)('.heart-count').textContent = res.data.data.user.hearts.length;
...
},{"axios":"../../node_modules/axios/index.js","./bling":"bling.js"}],"autocomplete.js":[function(require,module,exports) {
"use strict";
...
function loadPlaces(map) {
  ...
  (0, _axios.default)({
    method: 'GET',
    url: "/api/v1/stores/near?lat=".concat(lat, "&lng=").concat(lng)
  }).then(function (res) {
    var places = res.data;

    if (!places.length) {
      // alert('No places found!');
      (0, _alert.showAlert)('error', 'No places found!');
      return;
    } // create a bounds
    ...
    markers.forEach(function (marker) {
      return marker.addListener('click', function () {
        ...
        var html = "\n                    <div class=\"popup\">\n                        <a href=\"/store/".concat(_this.place.slug, ">\n                            <img src=\"/uploads/").concat(_this.place.photo, "\" alt=\"").concat(_this.place.name, "\" />\n                            <p>").concat(_this.place.name, " - ").concat(_this.place.location.address, "</p>\n                        </a>\n                    </div>\n                ");
...
exports.default = _default;
},{"axios":"../../node_modules/axios/index.js","./bling":"bling.js","./alert":"alert.js"}],"../../node_modules/dompurify/dist/purify.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{}],"typeAhead.js":[function(require,module,exports) {
"use strict";
...
function typeAhead(search) {
  ...
  searchInput.on('input', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/stores/search?q=".concat(this.value)
            });

          case 8:
            res = _context.sent;

            if (!res.data.data.stores.length) {
              _context.next = 12;
              break;
            }

            searchResults.innerHTML = _dompurify.default.sanitize(searchResultsHTML(res.data.data.stores));
            return _context.abrupt("return");

          case 12:
            searchResults.innerHTML = _dompurify.default.sanitize("<div class=\"search__result\">No results for ".concat(this.value, " found!</div>"));
            _context.next = 18;
            break;
...
exports.default = _default;
},{"axios":"../../node_modules/axios/index.js","dompurify":"../../node_modules/dompurify/dist/purify.js"}],"index.js":[function(require,module,exports) {
"use strict";
